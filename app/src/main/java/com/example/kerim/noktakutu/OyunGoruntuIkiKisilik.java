...
public class OyunGoruntuIkiKisilik extends View {
     ...
     */
    public OyunGoruntuIkiKisilik(Context icerik, String oyuncu1, String oyuncu2, int renk1, int renk2, String ekranBoyutu, boolean bilgisayar) {
        super(icerik);
    ...
    protected void temizle() {
        ...
        new AlertDialog.Builder(this.icerik).setTitle("Temizle").setMessage("Ekran Temizlensin mi?")
                .setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {

                    @Override
                    public void onClick(DialogInterface dialog, int whichButton) {
                        //Call the reset method.
                        OyunGoruntuIkiKisilik.this.ekranSifirla();
                    }
                }).setNegativeButton(R.string.hayir, null).create().show();
    }
        ...
        this.task = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    if (!OyunGoruntuIkiKisilik.this.oyun.seciliKutu()) {
                        //Set the oyun of the GameView to the result of the Bilgisayar thinking.
                        OyunGoruntuIkiKisilik.this.setOyun(OyunGoruntuIkiKisilik.this.bot.think(OyunGoruntuIkiKisilik.this.oyun));
                    }
            ...
            protected void onPostExecute(Void result) {
                //Invalidate the view.
                OyunGoruntuIkiKisilik.this.invalidate();
                //If the game has ended after the Bilgisayar's turn then show the winner.
                if (OyunGoruntuIkiKisilik.this.oyun.oyunBitti() && OyunGoruntuIkiKisilik.this.oyun.getPlayer() == 2) {
                    OyunGoruntuIkiKisilik.this.kazananOyuncu();
                }
            }
        };
    }
    ...
    private void kazananOyuncu() {
        ...
        AlertDialog.Builder kazanan = new AlertDialog.Builder(getContext());

        kazanan.setTitle("Oyun Tamamlandı");


        kazanan.setIcon(android.R.drawable.ic_dialog_alert);


        kazanan.setPositiveButton("Tamam", new DialogInterface.OnClickListener() {
        ...
        if (this.oyun.getOyuncu1Puan() == this.oyun.getOyuncu2Puan()) {
            kazanan.setMessage(this.icerik.getString(R.string.berabere));
        }
        // Else someone must have won.
            ...
            kazanan.setMessage(this.icerik.getString(R.string.tebrikler) + " " + winnerString
                    + this.icerik.getString(R.string.kazandı));
            if (this.bilgisayar == true && (this.oyun.getOyuncu1Puan() < this.oyun.getOyuncu2Puan())) {
                kazanan.setMessage(this.icerik.getString(R.string.kaybettin));
