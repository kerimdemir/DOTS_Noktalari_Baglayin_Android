...
public class MainActivity extends Activity {
    ...
    private CompoundButton botButton;
    ...
    public void onButtonClick(View view) {
        ...
        if (spOyuncu1.equalsIgnoreCase(spOyuncu2)) {
            ...
            intent.putExtra("usingBot", usingbot);
            // Start the intent
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.spinneriDoldur();
        this.botButton = (CompoundButton) this.findViewById(R.id.checkBox_Bilgisayar);
    ...
    public void bilgisayaraOyna(View view) {
        //Get the UI elements.
        EditText editOyuncu2 = (EditText) this.findViewById(R.id.edit_oyuncu2);
        TextView textViewBilgisayar = (TextView) this.findViewById(R.id.edit_oyuncu2);

        //If the botButton is checked.
        if (this.botButton.isChecked()) {
            //Hide the player 2 text field.
            editOyuncu2.setVisibility(View.GONE);
            //Show the computer text.
            textViewBilgisayar.setVisibility(View.VISIBLE);
        } else {
            //Show the player 2 text field.
            editOyuncu2.setVisibility(View.VISIBLE);
            //Hide the computer text.
            textViewBilgisayar.setVisibility(View.GONE);
        }
    }
}
